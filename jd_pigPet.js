...
[task_local]
#京东金融养猪猪
12 0-23/6 * * * https://raw.ggghhhusercontent.com/222222/sync/jd_scripts/jd_pigPet.js, tag=京东金融养猪猪, img-url=https://raw.ggghhhusercontent.com/58xinian/icon/master/jdyz.png, enabled=true

================Loon==============
[Script]
cron "12 0-23/6 * * *" script-path=https://raw.ggghhhusercontent.com/222222/sync/jd_scripts/jd_pigPet.js, tag=京东金融养猪猪

===============Surge=================
京东金融养猪猪 = type=cron,cronexp="12 0-23/6 * * *",wake-system=1,timeout=3600,script-path=https://raw.ggghhhusercontent.com/222222/sync/jd_scripts/jd_pigPet.js

============小火箭=========
京东金融养猪猪 = type=cron,script-path=https://raw.ggghhhusercontent.com/222222/sync/jd_scripts/jd_pigPet.js, cronexpr="12 0-23/6 * * *", timeout=3600, enable=true
*/
const $ = new Env('金融养猪');
...
!(async () => {
  ...
  if (process.env.PIGPETSHARECODE) {
    ...
    let res = await getAuthorShareCode('https://raw.ggghhhusercontent.com/222222/11111128/master/shareCodes/11111127')
    if (!res) {
  ...
  let res2 = await getAuthorShareCode('https://raw.ggghhhusercontent.com/222222/11111128/master/shareCodes/11111127')
  if (!res2) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/222222/11111128@master/shareCodes/11111127'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(2000)
