...
[task_local]
#整点京豆雨
0 0-23/1 * * * https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_super_redrain.js, tag=整点京豆雨, enabled=true
================Loon==============
[Script]
cron "0 0-23/1 * * *" script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_super_redrain.js, tag=整点京豆雨
===============Surge=================
整点京豆雨 = type=cron,cronexp="0 0-23/1 * * *",wake-system=1,timeout=20,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_super_redrain.js
============小火箭=========
整点京豆雨= type=cron,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_super_redrain.js, cronexpr="0 0-23/1 * * *",timeout=200, enable=true
*/
const $ = new Env("整点京豆雨");
let allMessage = "";
