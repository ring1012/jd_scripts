...
[task_local]
#发财大赢家
1 1,18 * * * https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_fcdyj.js, tag=发财大赢家, img-url=https://raw.ggghhhusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "1 1,18 * * *" script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_fcdyj.js tag=发财大赢家

===============Surge=================
发财大赢家 = type=cron,cronexp="1 1,18 * * *",wake-system=1,timeout=3600,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_fcdyj.js

============小火箭=========
发财大赢家 = type=cron,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_fcdyj.js, cronexpr="1 1,18 * * *", timeout=3600, enable=true
 */
...
function getAuthorShareCode() {
    return new Promise(resolve => {
        $.get({
            url: "https://raw.ggghhhusercontent.com/KingRan/jd/main/shareCodes/dyj.json",
            headers: {
