...
[task_local]
#发现好货
27 10,16 * 12 * https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_fxhh.js, tag=发现好货, enabled=true

================Loon==============
[Script]
cron "27 10,16 * 12 *" script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_fxhh.js,tag=发现好货

===============Surge=================
发现好货 = type=cron,cronexp="27 10,16 * 12 *",wake-system=1,timeout=3600,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_fxhh.js

============小火箭=========
发现好货 = type=cron,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_fxhh.js, cronexpr="27 10,16 * 12 *", timeout=3600, enable=true
*/
const $ = new Env('发现好货');
