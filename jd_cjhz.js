...
[task_local]
#京东超级盒子
24 3,13 * * * https://raw.ggghhhusercontent.com/msechen/script/main/jd_cjhz.js, tag=京东超级盒子, img-url=https://ggghhh.com/58xinian/icon/raw/master/jdgc.png, enabled=true
================Loon==============
[Script]
cron "24 3,13 * * *" script-path=https://raw.ggghhhusercontent.com/msechen/script/main/jd_cjhz.js,tag=京东超级盒子
===============Surge=================
京东超级盒子 = type=cron,cronexp="24 3,13 * * *",wake-system=1,timeout=3600,script-path=https://raw.ggghhhusercontent.com/msechen/script/main/jd_cjhz.js
============小火箭=========
京东超级盒子 = type=cron,script-path=https://raw.ggghhhusercontent.com/msechen/script/main/jd_cjhz.js, cronexpr="24 3,13 * * *", timeout=3600, enable=true
 */
...
// prettier-ignore
function Env(t, e) { "undefined" != typeof process && JSON.stringify(process.env).indexOf("GGGHHH") > -1 && process.exit(0);
