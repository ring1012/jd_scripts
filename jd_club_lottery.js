...
增加京东APP首页超级摇一摇(不定时有活动)(此功能部分京东API抓包自：https://ggghhh.com/i-chenzhe/qx/blob/main/jd_shake.js)
Modified from https://ggghhh.com/Zero-S1/JD_tools/blob/master/JD_vvipclub.py
已支持IOS双京东账号,Node.js支持N个京东账号
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
============QuantumultX==============
[task_local]
#摇京豆
5 0,23 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_club_lottery.js, tag=摇京豆, img-url=https://raw.ggghhhusercontent.com/58xinian/icon/master/jdyjd.png, enabled=true
=================Loon===============
[Script]
...
//超级摇一摇(此处功能部分京东API抓包自：https://ggghhh.com/i-chenzhe/qx/blob/main/jd_shake.js)
