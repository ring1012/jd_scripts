...
[task_local]
#宠汪汪积分兑换奖品
59 7,15,23 * * * https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_joy_reward.js, tag=宠汪汪积分兑换奖品, img-url=https://raw.ggghhhusercontent.com/58xinian/icon/master/jdcww.png, enabled=true

==============Loon==============
[Script]
cron "59 7,15,23 * * *" script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_joy_reward.js,tag=宠汪汪积分兑换奖品

================Surge===============
宠汪汪积分兑换奖品 = type=cron,cronexp="59 7,15,23 * * *",wake-system=1,timeout=3600,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_joy_reward.js

===============小火箭==========
宠汪汪积分兑换奖品 = type=cron,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_joy_reward.js, cronexpr="59 7,15,23 * * *", timeout=3600, enable=true
 */
...
// prettier-ignore
function Env(t, e) {
	"undefined" != typeof process && JSON.stringify(process.env).indexOf("GGGHHH") > -1 && process.exit(0);
	class s {
		constructor(t) {
			this.env = t
		}
