...
[task_local]
#京东领红包
0 0,10,20,22 * * * https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_red.js, tag=京东领红包, enabled=true

================Loon==============
[Script]
cron "0 0,10,20,22 * * *" script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_red.js,tag=京东领红包

===============Surge=================
京东领红包 = type=cron,cronexp="0 0,10,20,22 * * *",wake-system=1,timeout=3600,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_red.js

============小火箭=========
京东领红包 = type=cron,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_red.js, cronexpr="0 0,10,20,22 * * *", timeout=3600, enable=true
*/
const $ = new Env('京东领红包');
