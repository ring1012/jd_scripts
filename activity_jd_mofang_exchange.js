...
[task_local]
#5魔方兑换
0 7 * * * https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_mofang_exchange.js, tag=5魔方兑换, img-url=https://raw.ggghhhusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "0 7 * * *" script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_mofang_exchange.js,tag=5魔方兑换

===============Surge=================
5魔方兑换 = type=cron,cronexp="0 7 * * *",wake-system=1,timeout=3600,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_mofang_exchange.js

============小火箭=========
5魔方兑换 = type=cron,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_mofang_exchange.js, cronexpr="0 7 * * *", timeout=3600, enable=true
 */
const $ = new Env('5魔方兑换');
