...
[task_local]
#京喜财富岛合成珍珠
10 0-23/3 * * * https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js, tag=京喜财富岛合成珍珠, img-url=https://raw.ggghhhusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "10 0-23/3 * * *" script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js,tag=京喜财富岛合成珍珠

===============Surge=================
京喜财富岛合成珍珠 = type=cron,cronexp="10 0-23/3 * * *",wake-system=1,timeout=3600,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js

============小火箭=========
京喜财富岛合成珍珠 = type=cron,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_cfd_mooncake.js, cronexpr="10 0-23/3 * * *", timeout=3600, enable=true
 */
