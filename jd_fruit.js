...
[task_local]
#jd免费水果
5 6-18/6 * * * jd_fruit_task.js, tag=东东农场日常任务, img-url=https://raw.ggghhhusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
...
async function masterHelpShare() {
    ...
    console.log(`当前使用助力池${JD_ZLC_URL}`)
    r = {
        url: `https://zlc1.chaoyi996.com/api/app/booster-code/submit-real-contribution`,
        body: JSON.stringify(helpStatisticArr),
...
function Env(t, e) {
    ...
    return new class {
        ...
        async get(t, e = (async () => {
            ...
            this.initGotEnv(t);
            try{
                const myGot = require("got").extend({  retry:0,
                    // 设置请求超时时间
                    timeout:4000});
                console.log(myGot)
