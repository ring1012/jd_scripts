...
[task_local]
#惊喜牛牛
1 1,9,19 * * * https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_jxnn.js, tag=惊喜牛牛, img-url=https://ggghhh.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "1 1,9,19 * * *" script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_jxnn.js,tag=惊喜牛牛

===============Surge=================
惊喜牛牛 = type=cron,cronexp="1 1,9,19 * * *",wake-system=1,timeout=3600,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_jxnn.js

============小火箭=========
惊喜牛牛 = type=cron,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_jxnn.js, cronexpr="1 1,9,19 * * *", timeout=3600, enable=true
 */
const $ = new Env('牛牛福利');
