...
[task_local]
#京豆详情统计
20 22 * * * jd_bean_info.js, tag=京豆详情统计, img-url=https://raw.ggghhhusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
 * */
...
async function showMsg() {
  ...
  // }
  // $.msg($.name, '', `账号${$.index}：${$.nickName || $.UserName}\n今日收入：${$.todayIncomeBean}京豆 🐶\n昨日收入：${$.incomeBean}京豆 🐶\n昨日支出：${$.expenseBean}京豆 🐶\n当前京豆：${$.beanCount}(七天将过期${$.expirejingdou})京豆🐶${$.message}`, {"open-url": "https://bean.m.jd.com/beanDetail/index.action?resourceValue=bean", "media-url": "https://raw.ggghhhusercontent.com/Orz-3/mini/master/Color/jd.png"});
}
async function bean() {
