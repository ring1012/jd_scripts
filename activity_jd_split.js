...
[task_local]
#金榜年终奖
39 0,9 * * * https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_split.js, tag=年终奖, enabled=true

================Loon==============
[Script]
cron "39 0,9 * * *" script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_split.js,tag=年终奖

===============Surge=================
金榜年终奖 = type=cron,cronexp="39 0,9 * * *",wake-system=1,timeout=3600,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_split.js

============小火箭=========
金榜年终奖 = type=cron,script-path=https://raw.ggghhhusercontent.com/KingRan/JDJB/main/jd_split.js, cronexpr="39 0,9 * * *", timeout=3600, enable=true
 */
const $ = new Env('金榜年终奖');
